...
public class Java8FunctionalInterfaceNamingTest {
    ...
    public static Iterable<Object[]> data() {
        return Arrays.asList(new Object[][]{
                {"", "void", "run", Runnable.class.getName()},
                {"double", "void", "accept", DoubleConsumer.class.getName()},
                {"int", "void", "accept", IntConsumer.class.getName()},
                {"long", "void", "accept", LongConsumer.class.getName()},
                {"T", "void", "accept", Consumer.class.getName()},
                {"T, double", "void", "accept", ObjDoubleConsumer.class.getName()},
                {"T, int", "void", "accept", ObjIntConsumer.class.getName()},
                {"T, long", "void", "accept", ObjLongConsumer.class.getName()},
                {"T, U", "void", "accept", BiConsumer.class.getName()},
